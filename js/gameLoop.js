...
function rodada(sqr){
	if(sqr.value == EMPTY_val){
		if(turno==1){
			...
			sqr.value = O_val;
			sqr.style.backgroundImage = "url('image/bg.jpg')";
		}
		turno = turno*(-1);
		validaJogada();
	}
...
function reset(){
	...
	document.gameLoop.sqr1.style.backgroundColor = "yellow";
	document.gameLoop.sqr2.style.backgroundColor = "yellow";
	document.gameLoop.sqr3.style.backgroundColor = "yellow";
	document.gameLoop.sqr4.style.backgroundColor = "yellow";
	document.gameLoop.sqr5.style.backgroundColor = "yellow";
	document.gameLoop.sqr6.style.backgroundColor = "yellow";
	document.gameLoop.sqr7.style.backgroundColor = "yellow";
	document.gameLoop.sqr8.style.backgroundColor = "yellow";
	document.gameLoop.sqr9.style.backgroundColor = "yellow";
